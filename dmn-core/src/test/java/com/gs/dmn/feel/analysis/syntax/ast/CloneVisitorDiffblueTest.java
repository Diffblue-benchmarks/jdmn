...
public class CloneVisitorDiffblueTest {
  ...
  public void testVisit278() {
    // Arrange
    CloneVisitor cloneVisitor = new CloneVisitor();
    IfExpression element = new IfExpression(new NullTest(), new NullTest(), new NullTest());
    ...
    assertEquals("IfExpression(NullTest(), NullTest(), NullTest())", actualVisitResult.toString());
  }
