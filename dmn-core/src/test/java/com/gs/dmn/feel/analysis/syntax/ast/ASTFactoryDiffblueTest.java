...
public class ASTFactoryDiffblueTest {
  ...
  public void testToExpressionList() {
    ...
    // Act
    Expression actualToExpressionListResult = astFactory.toExpressionList(expressionList);

    // Assert
    assertTrue(actualToExpressionListResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertEquals("ExpressionList(ExpressionList(),ExpressionList())", actualToExpressionListResult.toString());
  }
  ...
  public void testToNegation3() {
    ...
    // Act and Assert
    assertSame(expressionList, astFactory.toNegation(stringList, expressionList));
  }
  ...
  public void testToNegation4() {
    ...
    // Act
    Expression actualToNegationResult = astFactory.toNegation(stringList, new ExpressionList());
  ...
  @Test
  public void testToDateTimeLiteral() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  @Test
  public void testToDateTimeLiteral2() {
    // Arrange and Act
  ...
  @Test
  public void testToNegatedSimpleUnaryTests() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  @Test
  public void testToSimplePositiveUnaryTests() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    ArrayList<Expression> expressionList = new ArrayList<Expression>();
    expressionList.add(new ExpressionList());
  ...
  public void testToPositiveUnaryTest() {
    ...
    // Act
    PositiveUnaryTest actualToPositiveUnaryTestResult = astFactory
        .toPositiveUnaryTest(new ArithmeticNegation(new NumericLiteral("value")));
    ...
    assertNull(actualOperator);
    assertEquals("OperatorTest(null,ArithmeticNegation(NumericLiteral" + "(value)))",
        actualToPositiveUnaryTestResult.toString());
  }
  ...
  public void testToPositiveUnaryTest2() {
    ...
    assertTrue(actualToPositiveUnaryTestResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertNull(actualOperator);
    assertEquals("OperatorTest(null,Name(name))", actualToPositiveUnaryTestResult.toString());
  }
  ...
  public void testToPositiveUnaryTest3() {
    ...
    // Act
    PositiveUnaryTest actualToPositiveUnaryTestResult = astFactory.toPositiveUnaryTest(new ListLiteral(expressionList));

    // Assert
    assertTrue(actualToPositiveUnaryTestResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertEquals("ListTest(ListLiteral(ExpressionList()))", actualToPositiveUnaryTestResult.toString());
  }

  @Test
  public void testToPositiveUnaryTest4() {
    // Arrange
    ...
    assertTrue(actualToPositiveUnaryTestResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertNull(actualOperator);
    assertEquals("OperatorTest(null,BooleanLiteral(value))", actualToPositiveUnaryTestResult.toString());
  }

  @Test
  public void testToPositiveUnaryTest5() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();

    // Act
    PositiveUnaryTest actualToPositiveUnaryTestResult = astFactory
        .toPositiveUnaryTest(new ArithmeticNegation(new ExpressionList()));

    // Assert
    assertTrue(actualToPositiveUnaryTestResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertEquals("ExpressionTest(ArithmeticNegation(ExpressionList" + "()))",
        actualToPositiveUnaryTestResult.toString());
  }

  @Test
  public void testToPositiveUnaryTest6() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  @Test
  public void testToPositiveUnaryTest7() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    ...
    Context context = new Context(contextEntryList);

    // Act
    PositiveUnaryTest actualToPositiveUnaryTestResult = astFactory.toPositiveUnaryTest(context);

    // Assert
    String actualOperator = ((OperatorTest) actualToPositiveUnaryTestResult).getOperator();
    assertTrue(actualToPositiveUnaryTestResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertNull(actualOperator);
    assertSame(context, ((OperatorTest) actualToPositiveUnaryTestResult).getEndpoint());
  }

  @Test
  public void testToPositiveUnaryTest8() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();

    // Act and Assert
    assertTrue(astFactory.toPositiveUnaryTest(new NullLiteral())
        .getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
  }

  @Test
  public void testToNullPositiveUnaryTest() {
    // Arrange, Act and Assert
  ...
  @Test
  public void testToExpressionTest() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  @Test
  public void testToNegatedUnaryTests() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  @Test
  public void testToFormalParameter() {
    // Arrange
  ...
  @Test
  public void testToFunctionDefinition() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  public void testToIteratorDomain() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    IteratorDomain toIteratorDomainResult = astFactory.toIteratorDomain(new ExpressionList(), new ExpressionList());

    // Act
    IteratorDomain actualToIteratorDomainResult = (new ASTFactory()).toIteratorDomain(null, null);

    // Assert
    assertEquals("RangeIteratorDomain(ExpressionList()," + " ExpressionList())", toIteratorDomainResult.toString());
    assertNull(((ExpressionIteratorDomain) actualToIteratorDomainResult).getExpression());
  }

  @Test
  public void testToContext() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    ArrayList<ContextEntry> contextEntryList = new ArrayList<ContextEntry>();
    contextEntryList.add(new ContextEntry(null, new ExpressionList()));
  ...
  @Test
  public void testToContextEntryKey() {
    // Arrange, Act and Assert
    assertEquals("-", (new ASTFactory()).toContextEntryKey("-").getKey());
  }

  @Test
  public void testToContextEntry() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    ExpressionList expressionList = new ExpressionList();
  ...
  @Test
  public void testToQuantifiedExpression() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    ArrayList<Iterator> iteratorList = new ArrayList<Iterator>();
    ExpressionList expressionList = new ExpressionList();
  ...
  @Test
  public void testToBetweenExpression() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  @Test
  public void testToInExpression() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();

    // Act
    Expression actualToInExpressionResult = astFactory.toInExpression(new NullTest(), new NullTest());

    // Assert
    assertTrue(actualToInExpressionResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertEquals("InExpression(NullTest(), NullTest())", actualToInExpressionResult.toString());
  }

  @Test
  public void testToInExpression2() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  public void testToFunctionInvocation3() {
    ...
    // Assert
    assertTrue(actualToFunctionInvocationResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
    assertEquals("FunctionInvocation(QualifiedName(foo, 1) ->" + " NamedParameters(foo : ExpressionList()))",
        actualToFunctionInvocationResult.toString());
  }

  @Test
  public void testToNamedParameters() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    HashMap<String, Expression> stringExpressionMap = new HashMap<String, Expression>();
    stringExpressionMap.put("foo", new ExpressionList());
  ...
  @Test
  public void testToNamedTypeExpression() {
    // Arrange
    Name exp = new Name("name");

    // Act
    TypeExpression actualToNamedTypeExpressionResult = (new ASTFactory()).toNamedTypeExpression(exp);

    // Assert
    assertEquals("name", ((NamedTypeExpression) actualToNamedTypeExpressionResult).getQualifiedName());
    assertTrue(actualToNamedTypeExpressionResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
  }

  @Test
  public void testToNamedTypeExpression2() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    ArrayList<String> stringList = new ArrayList<String>();
    stringList.add("foo");
    ...
    // Act
    TypeExpression actualToNamedTypeExpressionResult = astFactory.toNamedTypeExpression(new QualifiedName(stringList));

    // Assert
    assertEquals("foo", ((NamedTypeExpression) actualToNamedTypeExpressionResult).getQualifiedName());
    assertTrue(actualToNamedTypeExpressionResult.getType() instanceof com.gs.dmn.feel.analysis.semantics.type.AnyType);
  }

  @Test
  public void testToNamedTypeExpression3() {
    // Arrange and Act
  ...
  @Test
  public void testToListTypeExpression() {
    // Arrange
  ...
  @Test
  public void testToContextTypeExpression() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
  ...
  @Test
  public void testToFunctionTypeExpression() {
    // Arrange
    ASTFactory astFactory = new ASTFactory();
    NamedTypeExpression namedTypeExpression = new NamedTypeExpression("qualifiedName");
