...
public class DoubleUtilDiffblueTest {
  ...
  public void testDecimal() {
    ...
    Double actualDecimalResult = DoubleUtil.decimal(null, 1.0);

    // Act
    Double actualDecimalResult1 = DoubleUtil.decimal(1.0, null);

    // Assert
    assertEquals(1.0, decimalResult.doubleValue(), 0.0);
    assertNull(actualDecimalResult);
    assertNull(actualDecimalResult1);
  }
  ...
  public void testLog() {
    // Arrange
    Double logResult = DoubleUtil.log(1.0);

    // Act
    Double actualLogResult = DoubleUtil.log(null);

    // Assert
    assertEquals(0.0, logResult.doubleValue(), 0.0);
    assertNull(actualLogResult);
  }
  ...
  public void testMean2() {
    // Arrange, Act and Assert
    assertNull(DoubleUtil.mean(new ArrayList()));
  }
  ...
  public void testStddev() {
    // Arrange, Act and Assert
    assertNull(DoubleUtil.stddev(new ArrayList()));
  }
  ...
  public void testMode3() {
    // Arrange, Act and Assert
    assertEquals(0, DoubleUtil.mode(new ArrayList()).size());
  }
