...
public class InterpretedRuleOutputDiffblueTest {
  ...
  public void testSort() {
    ...
    InterpretedRuleOutput interpretedRuleOutput1 = new InterpretedRuleOutput(true, pair);
    ArrayList<RuleOutput> ruleOutputList = new ArrayList<RuleOutput>();
    ruleOutputList.add(interpretedRuleOutput1);
    ...
    assertEquals(interpretedRuleOutput1, getResult);
  ...
  public void testSort4() {
    // Arrange
    InterpretedRuleOutput interpretedRuleOutput = new InterpretedRuleOutput(false, 0);
    ArrayList<RuleOutput> ruleOutputList = new ArrayList<RuleOutput>();
    ...
    // Assert
    assertSame(ruleOutputList, actualSortResult);
    assertEquals(0, actualSortResult.size());
  }
  ...
  public void testEquals4() {
    ...
    // Act and Assert
    assertTrue(interpretedRuleOutput.equals(new InterpretedRuleOutput(false, 0)));
  }
