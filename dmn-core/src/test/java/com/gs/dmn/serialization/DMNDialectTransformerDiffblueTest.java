...
public class DMNDialectTransformerDiffblueTest {
  @Test
  public void testTransformDefinitions() {
    // Arrange
    DMNDialectTransformer dmnDialectTransformer = new DMNDialectTransformer(new NopBuildLogger());
    org.omg.spec.dmn._20151101.model.TDefinitions tDefinitions = new org.omg.spec.dmn._20151101.model.TDefinitions();
    tDefinitions.setExpressionLanguage("value");

    // Act and Assert
    org.omg.spec.dmn._20180521.model.TDefinitions left = dmnDialectTransformer.transformDefinitions(tDefinitions)
        .getLeft();
    ...
    assertEquals("value", left.getExpressionLanguage());
  ...
  @Test
  public void testTransformDefinitions2() {
    // Arrange
    DMNDialectTransformer dmnDialectTransformer = new DMNDialectTransformer(new NopBuildLogger());
